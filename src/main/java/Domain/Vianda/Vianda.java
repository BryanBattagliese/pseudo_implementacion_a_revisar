...
import Domain.Colaboradores.ColaboradorFisico;
...
public class Vianda {
    ...
    // < CONSTRUCTOR > //
    public Vianda(LocalDateTime fechaVencimiento, LocalDateTime fechaDonacion, ColaboradorFisico colaboradorQueLaDono) {
